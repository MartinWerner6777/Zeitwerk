        ...
        <Container className="max-w-2xl">
          ...
          <div className="mt-6 space-y-5 font-sans text-[15px] leading-relaxed text-tinte/75">
            ...
            <p>
              ...
              spreche vier Sprachen. Was für manche ungewöhnlich klingen mag,
              heißt für dich vor allem: aktuelles technisches Wissen, ohne
              den Umweg über eine große Agenturstruktur.
            </p>
          </div>
        </Container>
      </section>
