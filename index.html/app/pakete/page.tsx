...
const PAKETE = [
  {
    ...
    ticket: "№ 01",
    preis: "590 €",
    preisHinweis: "einmalig · 15 €/Monat Betriebskosten",
    zielgruppe: "Für Betriebe, die zum ersten Mal automatisieren.",
    items: [
      "Terminautomatisierung (auf Basis etablierter Buchungstools)",
      "Bewertungsautomatisierung",
      "Website-/WhatsApp-FAQ-Chatbot (auf freigegebene Inhalte begrenzt)",
  ...
  },
  {
    ...
    ticket: "№ 03",
    preis: "2.290 €",
    preisHinweis: "einmalig · 45 €/Monat Betriebskosten",
...
const WEBSITE_ZUSATZ = [
  { name: "Website-Relaunch", preis: "ab 690 €", info: "Überarbeitung einer bestehenden Website" },
  { name: "Website-Überarbeitung (klein)", preis: "ab 190 €", info: "Punktuelle Anpassungen" },
];
            ...
            <table className="w-full min-w-[560px] border-collapse font-sans text-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-center font-medium text-tinte">590 €</td>
                  <td className="px-4 py-3 text-center font-medium text-tinte">1.690 €</td>
                  <td className="px-4 py-3 text-center font-medium text-tinte">2.290 €</td>
                </tr>
              </tbody>
            </table>
          </div>
