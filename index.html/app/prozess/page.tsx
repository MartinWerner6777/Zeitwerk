...
const SCHRITTE = [
  ...
  },
  {
    ...
    titel: "Strategie",
    dauer: "1–2 Werktage",
    text: "Du bekommst einen konkreten Vorschlag: welche Leistungen sinnvoll sind, in welcher Reihenfolge, und was es kostet. Keine Buzzwords, keine unnötigen Extras. Bei Zusage werden 20 % des Projektpreises als Anzahlung fällig — die restlichen 80 % erst nach erfolgreichem Abschluss und deiner Zufriedenheit.",
  },
  {
    nr: "03",
    titel: "Umsetzung",
        ...
        <Container>
          ...
          <div className="mx-auto mt-4 max-w-2xl rounded-sm border border-dashed border-tinte/20 bg-papier2 p-6">
            ...
            <p className="mt-2 font-sans text-sm leading-relaxed text-tinte/65">
              Nach der Strategie-Phase werden 20 % des vereinbarten
              Projektpreises als Anzahlung fällig — das sichert den
              Projektstart für beide Seiten ab. Die restlichen 80 % werden
              erst berechnet, wenn das Ergebnis fertig ist und du wirklich
              zufrieden bist. Bis dahin sind alle notwendigen Anpassungen im
              Rahmen des vereinbarten Projekts selbstverständlich inklusive.
            </p>
          </div>
        </Container>
      </section>
