    ...
    <>
      <section className="relative overflow-hidden bg-werkstatt text-papier">
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg, #EFECE3 0px, #EFECE3 1px, transparent 1px, transparent 28px)",
          }}
        />
        <Container className="relative grid gap-12 py-20 md:grid-cols-[1.15fr_0.85fr] md:items-center md:py-28">
          <div>
            ...
            <p className="mt-6 max-w-lg font-sans text-lg leading-relaxed text-papier/75">
              W&amp;M Digital automatisiert Terminbuchung, Bewertungsanfragen
        ...
        <Container>
          <div className="grid gap-10 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-tinte md:text-4xl">
                Döner Point: vom Bestellzettel zum digitalen Dashboard.
              </h2>
              <p className="mt-5 font-sans text-[15px] leading-relaxed text-tinte/70">
                Für einen Döner-Imbiss auf der Chemnitzer Straße habe ich ein
                Bestell-Dashboard fürs Tablet gebaut, das Menü fürs
                Online-System aufbereitet und drei Menükarten-Entwürfe
                gestaltet.
              </p>
              <Link
                href="/referenzen"
            ...
            <div className="rounded-sm border border-tinte/10 bg-papier2 p-8 font-mono text-sm text-tinte/70">
              ...
              <p>Leistung — Bestell-Dashboard, Menü-Import, Menükarten</p>
