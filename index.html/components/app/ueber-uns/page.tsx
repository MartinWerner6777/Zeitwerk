        ...
        <Container className="max-w-2xl">
          ...
          <div className="mt-6 rounded-sm border border-tinte/10 bg-papier p-6">
            ...
            <p className="mt-2 font-sans text-sm leading-relaxed text-tinte/70">
              ...
              entwickelt, einen dazugehörigen Onlineshop aufgebaut, ein
              funktionierendes Kontaktformular programmiert, mehrere weitere
              Funktionen integriert und zusätzlich eine digitale Visitenkarte
              gestaltet und veröffentlicht, von der ersten Idee bis zum
              fertigen, laufenden Ergebnis.
            </p>
          </div>
        </Container>
      </section>
