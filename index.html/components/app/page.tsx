          ...
          <div className="grid gap-10 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-tinte md:text-4xl">
                Für viele Betriebe der naheliegendste erste Schritt.
              </h2>
              <p className="mt-4 max-w-md font-sans text-[15px] leading-relaxed text-tinte/70">
                Vom fokussierten Einstieg bis zur individuellen Lösung mit
                eigenen Funktionen, klar gestuft und zum Festpreis.
              </p>
              <p className="mt-5 font-display text-2xl font-semibold text-tinte">
                ab 890 €
              </p>
              <Link
                href="/pakete"
                className="focus-ring mt-6 inline-block rounded-sm bg-tinte px-6 py-3.5 font-sans text-[15px] font-semibold text-papier transition-transform hover:-translate-y-0.5"
              >
                Website-Angebote ansehen
              </Link>
            </div>
            <div className="grid gap-3 font-mono text-sm text-tinte/70">
              <div className="flex items-center justify-between rounded-sm border border-tinte/10 bg-papier2 px-5 py-4">
                <span className="font-sans text-tinte">Website-Start</span>
                <span className="text-messing">890 €</span>
              </div>
              <div className="flex items-center justify-between rounded-sm border border-tinte/10 bg-papier2 px-5 py-4">
                <span className="font-sans text-tinte">Unternehmenswebsite</span>
                <span className="text-messing">2.200 €</span>
              </div>
              <div className="flex items-center justify-between rounded-sm border border-tinte/10 bg-papier2 px-5 py-4">
                <span className="font-sans text-tinte">Premium-Website</span>
                <span className="text-messing">ab 4.200 €</span>
              </div>
            </div>
          </div>
        </Container>
          ...
          <div className="grid gap-10 md:grid-cols-[1fr_1fr] md:items-center">
            <div>
              ...
              <p className="mt-5 font-sans text-[15px] leading-relaxed text-tinte/70">
                ...
                komplette Website entwickelt, einen dazugehörigen Onlineshop
                aufgebaut, ein funktionierendes Kontaktformular programmiert
                und zusätzlich eine digitale Visitenkarte gestaltet und
                veröffentlicht.
              </p>
              <Link
                href="/referenzen"
            ...
            <div className="rounded-sm border border-tinte/10 bg-papier2 p-8 font-mono text-sm text-tinte/70">
              ...
              <p>Leistung: Website, Onlineshop, Kontaktformular, Visitenkarte</p>
