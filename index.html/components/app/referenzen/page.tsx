        ...
        <Container className="max-w-xl">
          <div className="rounded-sm border border-tinte/10 bg-papier p-8">
            ...
            <p className="mt-5 font-sans text-[15px] leading-relaxed text-tinte/70">
              ...
              Website entwickelt, einen dazugehörigen Onlineshop aufgebaut,
              ein funktionierendes Kontaktformular programmiert, mehrere
              weitere Funktionen integriert und zusätzlich eine digitale
            ...
            <ul className="mt-6 space-y-2 font-sans text-sm text-tinte/70">
              ...
              <li className="flex gap-2.5">
                <span className="text-messing">•</span> Onlineshop
              </li>
              <li className="flex gap-2.5">
