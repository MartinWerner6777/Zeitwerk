...
const GRUPPEN: Gruppe[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        badge: "Starter",
        inhalt:
          "Öffnungszeiten, Preise, Anfahrt, Verfügbarkeit: Ein auf deinen Betrieb trainierter Chatbot beantwortet die häufigsten Kundenfragen sofort, egal zu welcher Uhrzeit. Er antwortet ausschließlich auf Basis der von dir freigegebenen Inhalte und kennzeichnet sich klar als KI-Assistent. Fragen, die er nicht sicher beantworten kann, werden klar an dich weitergegeben statt geraten.",
      },
      {
        id: "kontaktformular",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "landingpage",
        titel: "Website-Start",
        untertitel: "Der fokussierte Einstieg: eine Seite, klar strukturiert",
        inhalt:
          "Eine einzelne, professionell gestaltete Seite. Ideal als erster eigener Auftritt oder für eine einzelne Kampagne, Aktion oder ein Angebot, ohne Änderungen an einer bestehenden Hauptwebsite.",
      },
      {
      ...
      <section className="bg-werkstatt py-20 text-papier md:py-28">
        <Container>
          ...
          <h1 className="mt-4 max-w-2xl font-display text-4xl font-semibold leading-tight md:text-5xl">
            15 Bausteine. Du brauchst nie alle, nur die, die bei dir Zeit kosten.
          </h1>
