...
export const metadata: Metadata = {
  title: "Kontakt zu Zeitwerk",
  description: "Kostenlose Potenzialanalyse für deinen Betrieb starten.",
};
        ...
        <div>
          ...
          <div className="mt-10 space-y-4 border-t border-tinte/10 pt-8 font-sans text-sm text-tinte/70">
            <p>
              ...
              <a href="mailto:hallo@zeitwerk.de" className="focus-ring rounded underline decoration-messing decoration-2 underline-offset-4">
                hallo@zeitwerk.de
              </a>
            </p>
            <p>
